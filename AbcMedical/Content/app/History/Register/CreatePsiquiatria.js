app.controller("CreatePsiquiatriaController", ['$scope', '$rootScope', 'AdminitrationFactory', '$location', 'HistoryFactory', 
    function ($scope, $rootScope, AdminitrationFactory, $location, HistoryFactory ) {
        ...
        vm.Registro.EnfermedadActual = "";
        vm.Registro.AntecedentesPersonales = "";
        vm.Registro.AntecedentesFamiliares = "";
        vm.Registro.PatronConsumo = "";
        vm.Registro.ExamenFisico = "";
        vm.Registro.ExamenMental = "";
        vm.Registro.Paraclinicos = "";
        vm.Registro.PrescripcionTratamiento = "";
        vm.Registro.EvolucionPertinencia = "";       
