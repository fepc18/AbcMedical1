app.controller("CreateSeguimientoSaludMentalController", ['$scope', '$rootScope', 'AdminitrationFactory', '$location', 'HistoryFactory',
    function ($scope, $rootScope, AdminitrationFactory, $location, HistoryFactory ) {

        var vm = this;
        vm.dataRequest = {};
        vm.RegistroClinicoId = 3;
        ...
        vm.Registro.Autoevaluacion = "";
        vm.Registro.NivelPermanencia = "";
        vm.Registro.NivelConvivencia = "";
        vm.Registro.Sexualidad = "";
        vm.Registro.ObjetivoSesion = "";
        vm.Registro.Evolucion = "";
        vm.Registro.PlanManejo = "";
        ...
        vm.save = function () {
            ...
            vm.RegistroHistoria.Asunto = vm.Registro.ObjetivoSesion;
