...
namespace ArchivoDigital.Controllers
{
    ...
    public class CargarArchivoDigitalController : Controller
    {
        private AbcMedicalContext db = new AbcMedicalContext();
        
        // GET: CargarArchivoDigital
        ...
        // GET: CargarArchivoDigital/Create
        public ActionResult Create()
        {   
           // ViewBag.PacienteId = new SelectList(db.Pacientes.OrderBy(X=>X.PrimerNombre), "PacienteId", "PrimerNombre");
        ...
        // POST: CargarArchivoDigital/Create
        [HttpPost]
        ...
        {
            var listado = db.Archivo.Where(x => x.PacienteId == id).ToList();
            return View("ListadoPrivado",listado);
        }
        public ActionResult ListadoPublico(int id)
        {
            var listado = db.Archivo.Where(x => x.PacienteId == id).ToList();
            return View("ListadoPublico", listado);
        }
        // GET: CargarArchivoDigital/Edit/5
        public ActionResult Edit(int id)
        {
            return View();
        }

        // POST: CargarArchivoDigital/Edit/5
        [HttpPost]
        ...
        // GET: CargarArchivoDigital/Delete/5
        public ActionResult Delete(int id)
        {
            
            Archivo arc = db.Archivo.Find(id);
            int idPaciente = arc.PacienteId;
            db.Archivo.Remove(arc);
            db.SaveChanges();
            var listado = db.Archivo.Where(x => x.PacienteId == idPaciente).ToList();
            return View("ListadoPrivado", listado);
        }

        // POST: CargarArchivoDigital/Delete/5
        [HttpPost]
        ...
        public static string GetExtension(string type)
        {
            ...
            return _mappings.TryGetValue(type, out extension) ? extension : ".txt";
        }
    }
}
